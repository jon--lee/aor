...
if __name__ == '__main__':
    paths = ['data/mujoco/Walker2d/other_frame_skipNone_force_mag5.0', 'data/mujoco/Walker2d/reg_other_frame_skipNone_force_mag5.0']
    titles = ['Walker w/o AOPR', 'Walker w/ AOPR']
